        ...
        if not self.ped_cfg is None:
            ...
            if self.ped_cfg["pedestrians"]["ped_tracker"]["enable"]:
                tracker = PedGenerator.createElement("node", props={"pkg": "pedestrian_tracker",
                    "type": "li2former_ros.py", "name": "pedestrian_tracker", "output": "screen"})
                ...
                cfg = "$(find pedestrian_tracker)/scripts/cfgs/" + self.ped_cfg["pedestrians"]["ped_tracker"]["cfg"]
                ...
                tracker.append(PedGenerator.createElement("param", props={"name": "cfg", "value": cfg}))
